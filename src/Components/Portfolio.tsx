                        ...
                        <div ref={ref1} className={`portfolioAppear ${inView1 ? 'inView' : ''}`}>
                              <h3>Digiruori</h3>
                                    ...
                                    <div className='group1'>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/AvaruuspeliKeski.jpg"} alt="Avaruuspeli" className='picturesSpace'/>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/Avaruuspeli.jpg"} alt="Avaruuspeli" className='picturesSpace'/>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/AvaruuspeliAloitus.jpg"} alt="Avaruuspeli" className='picturesSpace'/>
                                    </div>
                                    </a>
                        ...
                        <div ref={ref2} className={`portfolioAppear ${inView2 ? 'inView' : ''}`}>
                              ...
                              <a href="https://digiruori.fi/pelit/r6p2/" target="_blank"  rel="noopener noreferrer">
                                    <div className='group2'>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/KertotaulupeliKeski.jpg"} alt="Kertotaulupeli" className='picturesMulti'/>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/Kertotaulupeli.jpg"} alt="Kertotaulupeli" className='picturesMulti'/>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/KertotaulupeliAloitus.jpg"} alt="Kertotaulupeli" className='picturesMulti'/>
                                    </div>
                              </a>
                        ...
                        <div ref={ref3} className={`portfolioAppear ${inView3 ? 'inView' : ''}`}>
                              ...
                              <a href="http://www.jalkahoitola-askel.fi/" target="_blank"  rel="noopener noreferrer">
                                    <div className='group3'>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/Jalkahoitola-askelPalvelut.jpg"} alt="Jalkahoitola" className='picturesFeet'/>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/Jalkahoitola-askelYhteydenotto.jpg"} alt="Avaruuspeli" className='picturesFeet'/>
                                          <img src={process.env.PUBLIC_URL + "/Pictures/Jalkahoitola-askel.jpg"} alt="Avaruuspeli" className='picturesFeet'/>
                                    </div>
                              </a>
